        ...
        <section class="relative overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] shadow-2xl shadow-cyan-950/20">
            ...
            <div class="relative p-6 md:p-10">
                ...
                <p class="mt-4 max-w-2xl text-slate-300 leading-relaxed">
                    Tạo bài viết crypto mới. Bạn có thể thêm thumbnail chính và nhiều ảnh minh họa bên dưới nội dung bài viết.
                </p>
            </div>
        </section>
        ...
        <form method="POST"
            ...
            <section class="rounded-3xl border border-emerald-400/20 bg-emerald-400/10 p-5">
                ...
                <p class="mt-2 text-sm text-slate-300">
                    Chọn nhiều ảnh từ máy để minh họa cho bài viết. Các ảnh này sẽ hiển thị bên dưới nội dung bài.
                </p>
                ...
                <p class="mt-3 text-xs text-slate-400">
                    Hỗ trợ JPG, PNG, WEBP. Tối đa 8 ảnh, mỗi ảnh tối đa 4MB.
                </p>
            </section>
